...
function About() {
  return (
    <div>
      ...
      <div className="  px-4 mx-7   flex flex-row space-x-4 items-center ">
        <div className=" shadow-xl bg-opacity-40 md:bg-opacity-50
         m-7
         rounded-2xl  w-1/2  h-96 
         bg-gradient-to-r from-blue-900  to-pink-600 
         aspect-video ">
          <img src="photo-1630569267625-157f8f9d1a7e.png" className="w-screen  object-fill  h-96 object-cover rounded-2xl   opacity-40 " />
        ...
        <div className="my-7 float-right ">
          ...
          <dl className="flex flex-row mt-2 border-opacity-60 gap-8 border-y border-gray-900 items-center px-20 ">
        <div>
      ...
      <div class="  container  ml-20 flex flex-row space-x-5 items-center">
